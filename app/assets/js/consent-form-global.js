(function () {
  ...
  function applySavedAndDefaults() {
    var CTX = window.__CONSENT_FORM_CTX || {};
    var SAVED = window.__CONSENT_FORM_SAVED || {};
  ...
  async function saveNow() {
    ...
    var payload = {
      consent_form_pdf_id: parseInt(CTX.pdf_id || 0, 10),
    ...
    var res = await fetch(CTX.admin_base + "consent_form/save_submission", {
      method: "POST",
      body: fd
    });
    ...
    if (json.csrf_hash) {
      window.__CONSENT_FORM_CTX.csrf_hash = json.csrf_hash;
    }
